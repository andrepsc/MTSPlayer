...
function editRep(nome, repN) {
	...
	if (progressIndex[repN]) {
		...
		repHtml = repHtml.concat(" <input type=\"checkbox\" id=\"check-progress\">");
	}
	repHtml = repHtml.concat("<br>");
	...
	if (escIndex[repN]) {
		...
		repHtml = repHtml.concat(" <input type=\"checkbox\" id=\"check-esc\" >");
	}
...
function execEdit(repN) {
	...
	retreinoIndex[repN] = document.getElementById("check-retreino").checked;
	...
	for (var i = 0; i < tam; i++) {
		...
		if (rem[i].checked) {
			...
			nRem++;
                ...
                /*
                 * se nao nenhum dos reforços estiverem ativados,entao o repertorio é de teste e o retreino será desativado
                if(!rimg[i].checked && !rsom[i].checked) {
...
//essa função gera o download automatico do resultado da sessão
...
function showCredits() {
	...
	credHtml = credHtml.concat("<div style=\"text-align: center\">");
	...
	credHtml = credHtml.concat("<p>Ádamo Santana      [<a href=\"mailto:adamo@ufpa.br\">adamo@ufpa.br</a>]</p>");
	credHtml = credHtml.concat("<p>Antonio Jacob      [<a href=\"mailto:jacobjr@ufpa.br\">jacobjr@ufpa.br</a>]</p>");
	credHtml = credHtml.concat("<p>Dionne Cavalcante  [<a href=\"mailto:dionne@ufpa.br\">dionne@ufpa.br</a>]</p>");
	credHtml = credHtml.concat("<p>Gilberto Nerino    [<a href=\"mailto:gilberto@ufpa.br\">gilberto@ufpa.br</a>]</p>");
	credHtml = credHtml.concat("<p>Marcia Fontes      [<a href=\"mailto:marcia.pinheiro@itec.ufpa.br\">marcia.pinheiro@itec.ufpa.br</a>]</p>");
	credHtml = credHtml.concat("<p>Pedro Montibeler   [<a href=\"mailto:pedro.salvador@itec.ufpa.br\">pedro.salvador@itec.ufpa.br</a>]</p>");
